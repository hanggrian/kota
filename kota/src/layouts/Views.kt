...
inline fun ViewManager2.appWidgetHostView(init: (@KotaDsl _AppWidgetHostView).() -> Unit): AppWidgetHostView = _AppWidgetHostView(getContext()).apply(init).add()
...
inline fun ViewManager2.actionMenuView(init: (@KotaDsl _ActionMenuView).() -> Unit): ActionMenuView = _ActionMenuView(getContext()).apply(init).add()
...
inline fun ViewManager2.frameLayout(init: (@KotaDsl _FrameLayout).() -> Unit): FrameLayout = _FrameLayout(getContext()).apply(init).add()
...
inline fun ViewManager2.gridLayout(init: (@KotaDsl _GridLayout).() -> Unit): GridLayout = _GridLayout(getContext()).apply(init).add()
...
inline fun ViewManager2.gridView(init: (@KotaDsl _GridView).() -> Unit): GridView = _GridView(getContext()).apply(init).add()
...
inline fun ViewManager2.horizontalScrollView(init: (@KotaDsl _HorizontalScrollView).() -> Unit): HorizontalScrollView = _HorizontalScrollView(getContext()).apply(init).add()
...
inline fun ViewManager2.imageSwitcher(init: (@KotaDsl _ImageSwitcher).() -> Unit): ImageSwitcher = _ImageSwitcher(getContext()).apply(init).add()
...
inline fun ViewManager2.verticalLayout(init: (@KotaDsl _LinearLayout).() -> Unit): LinearLayout = _LinearLayout(getContext(), VERTICAL).apply(init).add()
...
inline fun ViewManager2.horizontalLayout(init: (@KotaDsl _LinearLayout).() -> Unit): LinearLayout = _LinearLayout(getContext(), HORIZONTAL).apply(init).add()
...
inline fun ViewManager2.radioGroup(init: (@KotaDsl _RadioGroup).() -> Unit): RadioGroup = _RadioGroup(getContext()).apply(init).add()
...
inline fun ViewManager2.relativeLayout(init: (@KotaDsl _RelativeLayout).() -> Unit): RelativeLayout = _RelativeLayout(getContext()).apply(init).add()
...
inline fun ViewManager2.scrollView(init: (@KotaDsl _ScrollView).() -> Unit): ScrollView = _ScrollView(getContext()).apply(init).add()
...
inline fun ViewManager2.tableLayout(init: (@KotaDsl _TableLayout).() -> Unit): TableLayout = _TableLayout(getContext()).apply(init).add()
...
inline fun ViewManager2.tableRow(init: (@KotaDsl _TableRow).() -> Unit): TableRow = _TableRow(getContext()).apply(init).add()
...
inline fun ViewManager2.textSwitcher(init: (@KotaDsl _TextSwitcher).() -> Unit): TextSwitcher = _TextSwitcher(getContext()).apply(init).add()
...
inline fun ViewManager2.toolbar(init: (@KotaDsl _Toolbar).() -> Unit): Toolbar = _Toolbar(getContext()).apply(init).add()
...
inline fun ViewManager2.viewAnimator(init: (@KotaDsl _ViewAnimator).() -> Unit): ViewAnimator = _ViewAnimator(getContext()).apply(init).add()
...
inline fun ViewManager2.viewSwitcher(init: (@KotaDsl _ViewSwitcher).() -> Unit): ViewSwitcher = _ViewSwitcher(getContext()).apply(init).add()
//endregion
...
@RequiresApi(16) @JvmOverloads inline fun ViewManager2.mediaRouteButton(noinline init: ((@KotaDsl MediaRouteButton).() -> Unit)? = null): MediaRouteButton = MediaRouteButton(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.gestureOverlayView(noinline init: ((@KotaDsl GestureOverlayView).() -> Unit)? = null): GestureOverlayView = GestureOverlayView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.extractEditText(noinline init: ((@KotaDsl ExtractEditText).() -> Unit)? = null): ExtractEditText = ExtractEditText(getContext()).apply { init?.invoke(this) }.add()
...
@RequiresApi(21) @JvmOverloads inline fun ViewManager2.tvView(noinline init: ((@KotaDsl TvView).() -> Unit)? = null): TvView = TvView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.glSurfaceView(noinline init: ((@KotaDsl GLSurfaceView).() -> Unit)? = null): GLSurfaceView = GLSurfaceView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.surfaceView(noinline init: ((@KotaDsl SurfaceView).() -> Unit)? = null): SurfaceView = SurfaceView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.textureView(noinline init: ((@KotaDsl TextureView).() -> Unit)? = null): TextureView = TextureView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.view(noinline init: ((@KotaDsl View).() -> Unit)? = null): View = View(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.viewStub(noinline init: ((@KotaDsl ViewStub).() -> Unit)? = null): ViewStub = ViewStub(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.webView(noinline init: ((@KotaDsl WebView).() -> Unit)? = null): WebView = WebView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.adapterViewFlipper(noinline init: ((@KotaDsl AdapterViewFlipper).() -> Unit)? = null): AdapterViewFlipper = AdapterViewFlipper(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.autoCompleteTextView(noinline init: ((@KotaDsl AutoCompleteTextView).() -> Unit)? = null): AutoCompleteTextView = AutoCompleteTextView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.button(noinline init: ((@KotaDsl Button).() -> Unit)? = null): Button = Button(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.calendarView(noinline init: ((@KotaDsl CalendarView).() -> Unit)? = null): CalendarView = CalendarView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.checkBox(noinline init: ((@KotaDsl CheckBox).() -> Unit)? = null): CheckBox = CheckBox(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.checkedTextView(noinline init: ((@KotaDsl CheckedTextView).() -> Unit)? = null): CheckedTextView = CheckedTextView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.chronometer(noinline init: ((@KotaDsl Chronometer).() -> Unit)? = null): Chronometer = Chronometer(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.datePicker(noinline init: ((@KotaDsl DatePicker).() -> Unit)? = null): DatePicker = DatePicker(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.editText(noinline init: ((@KotaDsl EditText).() -> Unit)? = null): EditText = EditText(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.expandableListView(noinline init: ((@KotaDsl ExpandableListView).() -> Unit)? = null): ExpandableListView = ExpandableListView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.imageButton(noinline init: ((@KotaDsl ImageButton).() -> Unit)? = null): ImageButton = ImageButton(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.imageView(noinline init: ((@KotaDsl ImageView).() -> Unit)? = null): ImageView = ImageView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.listView(noinline init: ((@KotaDsl ListView).() -> Unit)? = null): ListView = ListView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.multiAutoCompleteTextView(noinline init: ((@KotaDsl MultiAutoCompleteTextView).() -> Unit)? = null): MultiAutoCompleteTextView = MultiAutoCompleteTextView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.numberPicker(noinline init: ((@KotaDsl NumberPicker).() -> Unit)? = null): NumberPicker = NumberPicker(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.progressBar(noinline init: ((@KotaDsl ProgressBar).() -> Unit)? = null): ProgressBar = ProgressBar(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.quickContactBadge(noinline init: ((@KotaDsl QuickContactBadge).() -> Unit)? = null): QuickContactBadge = QuickContactBadge(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.radioButton(noinline init: ((@KotaDsl RadioButton).() -> Unit)? = null): RadioButton = RadioButton(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.ratingBar(noinline init: ((@KotaDsl RatingBar).() -> Unit)? = null): RatingBar = RatingBar(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.searchView(noinline init: ((@KotaDsl SearchView).() -> Unit)? = null): SearchView = SearchView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.seekBar(noinline init: ((@KotaDsl SeekBar).() -> Unit)? = null): SeekBar = SeekBar(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.space(noinline init: ((@KotaDsl Space).() -> Unit)? = null): Space = Space(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.spinner(noinline init: ((@KotaDsl Spinner).() -> Unit)? = null): Spinner = Spinner(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.stackView(noinline init: ((@KotaDsl StackView).() -> Unit)? = null): StackView = StackView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.switch(noinline init: ((@KotaDsl Switch).() -> Unit)? = null): Switch = Switch(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.tabHost(noinline init: ((@KotaDsl TabHost).() -> Unit)? = null): TabHost = TabHost(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.tabWidget(noinline init: ((@KotaDsl TabWidget).() -> Unit)? = null): TabWidget = TabWidget(getContext()).apply { init?.invoke(this) }.add()
...
@RequiresApi(17) @JvmOverloads inline fun ViewManager2.textClock(noinline init: ((@KotaDsl TextClock).() -> Unit)? = null): TextClock = TextClock(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.textView(noinline init: ((@KotaDsl TextView).() -> Unit)? = null): TextView = TextView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.timePicker(noinline init: ((@KotaDsl TimePicker).() -> Unit)? = null): TimePicker = TimePicker(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.toggleButton(noinline init: ((@KotaDsl ToggleButton).() -> Unit)? = null): ToggleButton = ToggleButton(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.videoView(noinline init: ((@KotaDsl VideoView).() -> Unit)? = null): VideoView = VideoView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.viewFlipper(noinline init: ((@KotaDsl ViewFlipper).() -> Unit)? = null): ViewFlipper = ViewFlipper(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.zoomControls(noinline init: ((@KotaDsl ZoomControls).() -> Unit)? = null): ZoomControls = ZoomControls(getContext()).apply { init?.invoke(this) }.add()
//endregion