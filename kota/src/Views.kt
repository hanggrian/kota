...
inline fun <reified T : View> View.findOrNull(@IdRes id: Int): T? = findViewById(id) as? T
inline fun <reified T : View> Activity.findOrNull(@IdRes id: Int): T? = findViewById(id) as? T
inline fun <reified T : View> Fragment.findOrNull(@IdRes id: Int): T? = view?.findViewById(id) as? T
inline fun <reified T : View> Dialog.findOrNull(@IdRes id: Int): T? = findViewById(id) as? T
