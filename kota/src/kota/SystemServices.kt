...
@PublishedApi
internal inline fun <reified T> Context.getSystemServiceNotNull(name: String): T = getSystemService(name)!! as T

inline val Context.accessibilityManager: AccessibilityManager get() = getSystemServiceNotNull(ACCESSIBILITY_SERVICE)
...
inline val Context.accountManager: AccountManager get() = getSystemServiceNotNull(ACCOUNT_SERVICE)
...
inline val Context.activityManager: ActivityManager get() = getSystemServiceNotNull(ACTIVITY_SERVICE)
...
inline val Context.alarmManager: AlarmManager get() = getSystemServiceNotNull(ALARM_SERVICE)
...
inline val Context.appOpsManager: AppOpsManager @RequiresApi(19) get() = getSystemServiceNotNull(APP_OPS_SERVICE)
...
inline val Context.appWidgetManager: AppWidgetManager @RequiresApi(21) get() = getSystemServiceNotNull(APPWIDGET_SERVICE)
...
inline val Context.audioManager: AudioManager get() = getSystemServiceNotNull(AUDIO_SERVICE)
...
inline val Context.batteryManager: BatteryManager @RequiresApi(21) get() = getSystemServiceNotNull(BATTERY_SERVICE)
...
inline val Context.bluetoothManager: BluetoothManager @RequiresApi(18) get() = getSystemServiceNotNull(BLUETOOTH_SERVICE)
...
inline val Context.clipboardManager: ClipboardManager get() = getSystemServiceNotNull(CLIPBOARD_SERVICE)
...
inline val Context.connectivityManager: ConnectivityManager get() = getSystemServiceNotNull(CONNECTIVITY_SERVICE)
...
inline val Context.consumerIrManager: ConsumerIrManager @RequiresApi(19) get() = getSystemServiceNotNull(CONSUMER_IR_SERVICE)
...
inline val Context.devicePolicyManager: DevicePolicyManager get() = getSystemServiceNotNull(DEVICE_POLICY_SERVICE)
...
inline val Context.displayManager: DisplayManager @RequiresApi(17) get() = getSystemServiceNotNull(DISPLAY_SERVICE)
...
inline val Context.downloadManager: DownloadManager get() = getSystemServiceNotNull(DOWNLOAD_SERVICE)
...
inline val Context.dropBoxManager: DropBoxManager get() = getSystemServiceNotNull(DROPBOX_SERVICE)
...
inline val Context.fingerprintManager: FingerprintManager @RequiresApi(23) get() = getSystemServiceNotNull(FINGERPRINT_SERVICE)
...
inline val Context.inputMethodManager: InputMethodManager get() = getSystemServiceNotNull(INPUT_METHOD_SERVICE)
...
inline val Context.inputManager: InputManager @RequiresApi(16) get() = getSystemServiceNotNull(INPUT_SERVICE)
...
inline val Context.jobScheduler: JobScheduler @RequiresApi(21) get() = getSystemServiceNotNull(JOB_SCHEDULER_SERVICE)
...
inline val Context.keyguardManager: KeyguardManager get() = getSystemServiceNotNull(KEYGUARD_SERVICE)
...
inline val Context.launcherApps: LauncherApps @RequiresApi(21) get() = getSystemServiceNotNull(LAUNCHER_APPS_SERVICE)
...
inline val Context.locationManager: LocationManager get() = getSystemServiceNotNull(LOCATION_SERVICE)
...
inline val Context.mediaProjectionManager: MediaProjectionManager @RequiresApi(21) get() = getSystemServiceNotNull(MEDIA_PROJECTION_SERVICE)
...
inline val Context.mediaRouter: MediaRouter @RequiresApi(16) get() = getSystemServiceNotNull(MEDIA_ROUTER_SERVICE)
...
inline val Context.mediaSessionManager: MediaSessionManager @RequiresApi(21) get() = getSystemServiceNotNull(MEDIA_SESSION_SERVICE)
...
inline val Context.midiManager: MidiManager @RequiresApi(23) get() = getSystemServiceNotNull(MIDI_SERVICE)
...
inline val Context.networkStatsManager: NetworkStatsManager @RequiresApi(23) get() = getSystemServiceNotNull(NETWORK_STATS_SERVICE)
...
inline val Context.nfcManager: NfcManager get() = getSystemServiceNotNull(NFC_SERVICE)
...
inline val Context.notificationManager: NotificationManager get() = getSystemServiceNotNull(NOTIFICATION_SERVICE)
...
inline val Context.nsdManager: NsdManager @RequiresApi(16) get() = getSystemServiceNotNull(NSD_SERVICE)
...
inline val Context.powerManager: PowerManager get() = getSystemServiceNotNull(POWER_SERVICE)
...
inline val Context.printManager: PrintManager @RequiresApi(19) get() = getSystemServiceNotNull(PRINT_SERVICE)
...
inline val Context.restrictionsManager: RestrictionsManager @RequiresApi(21) get() = getSystemServiceNotNull(RESTRICTIONS_SERVICE)
...
inline val Context.searchManager: SearchManager get() = getSystemServiceNotNull(SEARCH_SERVICE)
...
inline val Context.sensorManager: SensorManager get() = getSystemServiceNotNull(SENSOR_SERVICE)
...
inline val Context.storageManager: StorageManager get() = getSystemServiceNotNull(STORAGE_SERVICE)
...
inline val Context.subscriptionManager: SubscriptionManager @RequiresApi(22) get() = getSystemServiceNotNull(TELEPHONY_SUBSCRIPTION_SERVICE)
...
inline val Context.telecomManager: TelecomManager @RequiresApi(21) get() = getSystemServiceNotNull(TELECOM_SERVICE)
...
inline val Context.telephonyManager: TelephonyManager get() = getSystemServiceNotNull(TELEPHONY_SERVICE)
...
inline val Context.textServicesManager: TextServicesManager get() = getSystemServiceNotNull(TEXT_SERVICES_MANAGER_SERVICE)
...
inline val Context.tvInputManager: TvInputManager @RequiresApi(21) get() = getSystemServiceNotNull(TV_INPUT_SERVICE)
...
inline val Context.uiModeManager: UiModeManager get() = getSystemServiceNotNull(UI_MODE_SERVICE)
...
inline val Context.usageStatsManager: UsageStatsManager @RequiresApi(22) get() = getSystemServiceNotNull(USAGE_STATS_SERVICE)
...
inline val Context.usbManager: UsbManager get() = getSystemServiceNotNull(USB_SERVICE)
...
inline val Context.userManager: UserManager @RequiresApi(17) get() = getSystemServiceNotNull(USER_SERVICE)
...
inline val Context.vibrator: Vibrator get() = getSystemServiceNotNull(VIBRATOR_SERVICE)
inline val Fragment.vibrator: Vibrator get() = activity.vibrator
inline val Dialog.vibrator: Vibrator get() = context.vibrator

inline val Context.wallpaperManager: WallpaperManager get() = getSystemServiceNotNull(WALLPAPER_SERVICE)
...
inline val Context.wifiManager: WifiManager get() = applicationContext.getSystemServiceNotNull(WIFI_SERVICE)
...
inline val Context.wifiP2pManager: WifiP2pManager get() = getSystemServiceNotNull(WIFI_P2P_SERVICE)
...
inline val Context.windowManager: WindowManager get() = getSystemServiceNotNull(WINDOW_SERVICE)
