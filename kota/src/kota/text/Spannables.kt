...
inline fun Spannable.span(regex: Regex, vararg spans: () -> Any): Spannable = span(regex, SPAN_EXCLUSIVE_EXCLUSIVE, *spans)
...
inline fun Spannable.spanFirst(regex: Regex, vararg spans: () -> Any): Spannable = spanFirst(regex, SPAN_EXCLUSIVE_EXCLUSIVE, *spans)
...
inline fun Spannable.spanRange(start: Int, end: Int, vararg spans: () -> Any): Spannable = spanRange(start, end, SPAN_EXCLUSIVE_EXCLUSIVE, *spans)
...
inline fun Spannable.spanRange(range: IntRange, vararg spans: () -> Any): Spannable = spanRange(range, SPAN_EXCLUSIVE_EXCLUSIVE, *spans)
...
inline fun Spannable.spanBefore(delimiter: Char, vararg spans: () -> Any): Spannable = spanBefore(delimiter, SPAN_EXCLUSIVE_EXCLUSIVE, *spans)
...
inline fun Spannable.spanBefore(delimiter: String, vararg spans: () -> Any): Spannable = spanBefore(delimiter, SPAN_EXCLUSIVE_EXCLUSIVE, *spans)
...
inline fun Spannable.spanAfter(delimiter: Char, vararg spans: () -> Any): Spannable = spanAfter(delimiter, SPAN_EXCLUSIVE_EXCLUSIVE, *spans)
...
inline fun Spannable.spanAfter(delimiter: String, vararg spans: () -> Any): Spannable = spanAfter(delimiter, SPAN_EXCLUSIVE_EXCLUSIVE, *spans)

inline fun Spannable.spanAll(flags: Int, vararg spans: () -> Any): Spannable = spanRange(0, length, flags, *spans)

inline fun Spannable.spanAll(vararg spans: () -> Any): Spannable = spanAll(SPAN_EXCLUSIVE_EXCLUSIVE, *spans)
