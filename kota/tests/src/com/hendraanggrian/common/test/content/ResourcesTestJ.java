...
public class ResourcesTestJ {
    ...
    public void getQuantityText() throws Exception {
        assertEquals(
                getTargetContext().getResources().getQuantityText(com.hendraanggrian.common.test.R.plurals.test_plural, 2),
                Resources2.getQuantityText(getTargetContext(), com.hendraanggrian.common.test.R.plurals.test_plural, 2));
    }
    ...
    public void getQuantityString() throws Exception {
        assertEquals(
                getTargetContext().getResources().getQuantityString(com.hendraanggrian.common.test.R.plurals.test_plural2, 1, 2),
                Resources2.getQuantityString(getTargetContext(), com.hendraanggrian.common.test.R.plurals.test_plural2, 1, 2));
    }
    ...
    public void getIntArray() throws Exception {
        assertArrayEquals(
                getTargetContext().getResources().getIntArray(com.hendraanggrian.common.test.R.array.test_integer_array),
                Resources2.getIntArray(getTargetContext(), com.hendraanggrian.common.test.R.array.test_integer_array));
    }
    ...
    public void getBoolean() throws Exception {
        assertEquals(
                getTargetContext().getResources().getBoolean(com.hendraanggrian.common.test.R.bool.abc_action_bar_embed_tabs),
                Resources2.getBoolean(getTargetContext(), com.hendraanggrian.common.test.R.bool.abc_action_bar_embed_tabs));
    }

    @Test
    public void getLayout() throws Exception {
        assertEquals(
                getTargetContext().getResources().getLayout(com.hendraanggrian.common.test.R.layout.activity_viewgroups),
                Resources2.getLayout(getTargetContext(), com.hendraanggrian.common.test.R.layout.activity_viewgroups));
    }
    ...
    public void getXml() throws Exception {
        assertEquals(
                getTargetContext().getResources().getXml(com.hendraanggrian.common.test.R.xml.test_xml),
                Resources2.getXml(getTargetContext(), com.hendraanggrian.common.test.R.xml.test_xml));
    }
}