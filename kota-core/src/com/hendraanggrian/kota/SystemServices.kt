...
inline val Fragment.wallpaperService: WallpaperService get() = activity.wallpaperService
inline val Context.wallpaperService: WallpaperService get() = getSystemService(Context.WALLPAPER_SERVICE) as WallpaperService

inline val Fragment.wifiManager: WifiManager get() = activity.wifiManager
inline val Context.wifiManager: WifiManager get() = getSystemService(Context.WIFI_SERVICE) as WifiManager
