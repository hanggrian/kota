...
@ColorInt
@JvmOverloads inline fun colorIntOf(r: Int, g: Int, b: Int, a: Int = 0xFF): Int = Color.argb(a, r, g, b)
...
@TargetApi(26)
@RequiresApi(26)
@JvmOverloads inline fun colorOf(r: Float, g: Float, b: Float, a: Float = 0xFF.toFloat(), colorSpace: ColorSpace? = null): Color = when {
