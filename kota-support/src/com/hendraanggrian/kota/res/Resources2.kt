...
@JvmOverloads inline fun Fragment.getText(@StringRes id: Int, def: CharSequence? = null): CharSequence = context.getText(id, def)
...
@JvmOverloads inline fun Fragment.getQuantityString(@PluralsRes id: Int, quantity: Int, vararg formatArgs: Any = emptyArray()): String = context.getQuantityString(id, quantity, formatArgs)
...
@SuppressLint("Recycle") inline fun Fragment.obtainTypedArray(@ArrayRes id: Int): TypedArray = context.obtainTypedArray(id)
...
@ColorInt inline fun Fragment.getColor2(@ColorRes id: Int): Int = context.getColor2(id)
...
@JvmOverloads inline fun Fragment.openRaw(@RawRes id: Int, value: TypedValue? = null): InputStream = context.openRaw(id, value)
