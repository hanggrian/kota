...
inline fun ViewManager2.fragmentTabHost(init: (@KotaDsl _FragmentTabHost).() -> Unit): FragmentTabHost = _FragmentTabHost(getContext()).apply(init).add()
...
inline fun ViewManager2.viewPager(init: (@KotaDsl _ViewPager).() -> Unit): ViewPager = _ViewPager(getContext()).apply(init).add()
...
inline fun ViewManager2.drawerLayout(init: (@KotaDsl _DrawerLayout).() -> Unit): DrawerLayout = _DrawerLayout(getContext()).apply(init).add()
...
inline fun ViewManager2.nestedScrollView(init: (@KotaDsl _NestedScrollView).() -> Unit): NestedScrollView = _NestedScrollView(getContext()).apply(init).add()
...
inline fun ViewManager2.slidingPaneLayout(init: (@KotaDsl _SlidingPaneLayout).() -> Unit): SlidingPaneLayout = _SlidingPaneLayout(getContext()).apply(init).add()
//endregion
...
@JvmOverloads inline fun ViewManager2.pagerTabStrip(noinline init: ((@KotaDsl PagerTabStrip).() -> Unit)? = null): PagerTabStrip = PagerTabStrip(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.pagerTitleStrip(noinline init: ((@KotaDsl PagerTitleStrip).() -> Unit)? = null): PagerTitleStrip = PagerTitleStrip(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.contentLoadingProgressBar(noinline init: ((@KotaDsl ContentLoadingProgressBar).() -> Unit)? = null): ContentLoadingProgressBar = ContentLoadingProgressBar(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.supportSpace(noinline init: ((@KotaDsl Space).() -> Unit)? = null): Space = Space(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.swipeRefreshLayout(noinline init: ((@KotaDsl SwipeRefreshLayout).() -> Unit)? = null): SwipeRefreshLayout = SwipeRefreshLayout(getContext()).apply { init?.invoke(this) }.add()
//endregion