...
inline fun ViewManager2.listMenuItemView(init: (@KotaDsl _ListMenuItemView).() -> Unit): ListMenuItemView = _ListMenuItemView(getContext()).apply(init).add()
...
inline fun ViewManager2.actionBarContainer(init: (@KotaDsl _ActionBarContainer).() -> Unit): ActionBarContainer = _ActionBarContainer(getContext()).apply(init).add()
...
inline fun ViewManager2.actionBarOverlayLayout(init: (@KotaDsl _ActionBarOverlayLayout).() -> Unit): ActionBarOverlayLayout = _ActionBarOverlayLayout(getContext()).apply(init).add()
...
inline fun ViewManager2.supportActionMenuView(init: (@KotaDsl _ActionMenuViewV7).() -> Unit): ActionMenuView = _ActionMenuViewV7(getContext()).apply(init).add()
...
inline fun ViewManager2.alertDialogLayout(init: (@KotaDsl _AlertDialogLayout).() -> Unit): AlertDialogLayout = _AlertDialogLayout(getContext()).apply(init).add()
...
inline fun ViewManager2.buttonBarLayout(init: (@KotaDsl _ButtonBarLayout).() -> Unit): ButtonBarLayout = _ButtonBarLayout(getContext()).apply(init).add()
...
inline fun ViewManager2.verticalLayoutCompat(init: (@KotaDsl _LinearLayoutCompat).() -> Unit): LinearLayoutCompat = _LinearLayoutCompat(getContext(), VERTICAL).apply(init).add()
...
inline fun ViewManager2.horizontalLayoutCompat(init: (@KotaDsl _LinearLayoutCompat).() -> Unit): LinearLayoutCompat = _LinearLayoutCompat(getContext(), HORIZONTAL).apply(init).add()
...
inline fun ViewManager2.listViewCompat(init: (@KotaDsl _ListViewCompat).() -> Unit): ListViewCompat = _ListViewCompat(getContext()).apply(init).add()
...
inline fun ViewManager2.scrollingTabContainerView(init: (@KotaDsl _ScrollingTabContainerView).() -> Unit): ScrollingTabContainerView = _ScrollingTabContainerView(getContext()).apply(init).add()
...
inline fun ViewManager2.supportToolbar(init: (@KotaDsl _ToolbarV7).() -> Unit): Toolbar = _ToolbarV7(getContext()).apply(init).add()
//endregion
...
@JvmOverloads inline fun ViewManager2.contentFrameLayout(noinline init: ((@KotaDsl ContentFrameLayout).() -> Unit)? = null): ContentFrameLayout = ContentFrameLayout(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.supportSearchView(noinline init: ((@KotaDsl SearchView).() -> Unit)? = null): SearchView = SearchView(getContext()).apply { init?.invoke(this) }.add()
...
@JvmOverloads inline fun ViewManager2.switchCompat(noinline init: ((@KotaDsl SwitchCompat).() -> Unit)? = null): SwitchCompat = SwitchCompat(getContext()).apply { init?.invoke(this) }.add()
//endregion